...
/*!
  ...
  * If your custom KinObject needs some custom initialization, use KinInitMacro or
  * KinInitMacro2.
  */
 ...
 * \param other
 *
 * Use the macro KinInitMacro to customize your KinObject to declare this function
 * and call it whenever a copy construction or assignment operation is performed.
 * This function is generated by KinInitMacro and KinInitMacro2
 */
...
/*!
  ...
  * then you should use KinInitMacro.
  */

#define KinInitMacro2(Y,X) inline Y ( const Y & copy ## Y ) : \
                              akin::KinObject( copy ## Y ), \
                              X ( copy ## Y ) \
                              { _kinitialize( copy ## Y ); } \
                          inline Y & operator=( const Y & copy ## Y ) \
...
#define KinInitMacro(Y) inline Y ( const Y & copy ## Y ) : \
